 ...
 * @author mjavka
 */
@ManagedBean(name = "ExpertEvaluationsPage")
@SessionScoped
public class ExpertEvaluationsPageAction extends CommonManagerAction {
...
// </editor-fold>
    ...
    public String show(Program program)
    {
        ...
        return "expertEvaluationsPage.htm?faces-redirect=true";
    }
