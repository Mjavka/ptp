 ...
 * @author mjavka
 */
@ManagedBean(name = "ExpertQuestionnaire")
@SessionScoped
public class ExpertQuestionnaireAction extends AbstractFormAction {
    ...
    public String init(String programUuid, String userUuid) {
        ...
        if (!getUserProgram().getAnket().getGroups().isEmpty()) {   
         ...
         return "ExpertQuestionnaire.htm?gu=" + getCurrentGroup().getGroupUuid() + "&faces-redirect=true";
    }
